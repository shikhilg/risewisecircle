...
const SERVICES = [
  ...
  {
    title: "Mindful Living & Habits",
    desc: "Transform your daily life through mindfulness practices and intentional habit building. Create sustainable routines that align with your goals and values.",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    title: "Relationships & Emotional Empowerment",
    desc: "Build deeper, healthier relationships by developing emotional intelligence and empowerment. Learn to communicate authentically and connect meaningfully.",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
