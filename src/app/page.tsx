          ...
          <AnimateOnScroll delay={400}>
            <div className="mt-12 flex flex-col sm:flex-row items-start sm:items-center gap-6">
              <a
                ...
                className="inline-flex items-center gap-3 px-7 py-3.5 rounded-full border border-foreground/10 text-sm font-medium text-foreground/80 hover:border-accent/30 hover:bg-accent/5 transition-all duration-300"
              >
