...
const SERVICES = [
  ...
  },
  {
    ...
    desc: "Gently reconnect with and heal your inner child. Release old wounds, embrace self-compassion, and rediscover the joy and creativity within you.",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    desc: "Immersive group experiences including Life Synchronicity workshops, stress reduction programs, and transformational retreats designed for collective growth.",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    <>
      ...
      <section className="py-28 sm:py-36 px-6 bg-surface/40">
        <div className="max-w-5xl mx-auto">
          ...
          <AnimateOnScroll delay={200}>
            <p className="mt-6 text-muted text-base sm:text-lg leading-relaxed max-w-2xl">
              Follow along on Instagram for daily inspiration, coaching
              insights, mindfulness tips, and behind-the-scenes of the
              RiseWise Circle journey.
            </p>
          </AnimateOnScroll>
